...
<head>
    ...
    <link href="{{ asset('dashboard/dashboard/dashboard.css') }}" rel="stylesheet">
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">YIT</a>
    ...
    <script src="{{ asset('dashboard/assets/dist/js/bootstrap.bundle.min.js') }}" class="astro-vvvwv3sm"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js@4.3.2/dist/chart.umd.js"
        integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp" crossorigin="anonymous"
        class="astro-vvvwv3sm"></script>
    <script src="{{ asset('dashboard/dashboard/dashboard.js') }}" class="astro-vvvwv3sm"></script>
</body>
